package com.pexax.springboot_project.bootstrap;

import com.pexax.springboot_project.entity.*;
import com.pexax.springboot_project.repository.CategoryRepository;
import com.pexax.springboot_project.repository.RecipeRepository;
import com.pexax.springboot_project.repository.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent>
{
    ...
    private List<Recipe> getRecipes()
    {
        ...
        //get Categories
        Optional<Category> americanCategoryOptional = categoryRepository.findByDescription("Turkish");
        ...
        guacNotes.setRecepeNotes("For a very quick guacamole just take a 1/4 cup of salsa and mix it in with your mashed avocados.\n" +
        ...
        tacoNotes.setRecepeNotes("We have a family motto and it is this: Everything goes better in a tortilla.\n" +
